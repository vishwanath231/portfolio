    ...
    [712], {
        ...
        8494: function(e, t, s) {
            ...
            function m(e) {
                ...
                let w, b, y, C, S;
                n.includes("thumbs") && i.thumbs && i.thumbs.swiper && u.thumbs && !u.thumbs.swiper && (w = !0), n.includes("controller") && i.controller && i.controller.control && u.controller && !u.controller.control && (b = !0), n.includes("pagination") && i.pagination && (i.pagination.el || c) && (u.pagination || !1 === u.pagination) && f && !f.el && (y = !0), n.includes("scrollbar") && i.scrollbar && (i.scrollbar.el || d) && (u.scrollbar || !1 === u.scrollbar) && m && !m.el && (C = !0), n.includes("navigation") && i.navigation && (i.navigation.prevEl || o) && (i.navigation.nextEl || l) && (u.navigation || !1 === u.navigation) && h && !h.prevEl && !h.nextEl && (S = !0);
                if (p.forEach((e => {
                        ...
                        var s
                    })), p.includes("controller") && !b && t.controller && t.controller.control && u.controller && u.controller.control && (t.controller.control = u.controller.control), n.includes("children") && s && g && u.virtual.enabled ? (g.slides = s, g.update(!0)) : n.includes("children") && t.lazy && t.params.lazy.enabled && t.lazy.load(), w) {
                    v.init() && v.update(!0)
                }
            ...
            const y = (0, i.forwardRef)((function(e, t) {
                ...
                const [T, x] = (0, i.useState)("swiper"), [P, $] = (0, i.useState)(null), [k, M] = (0, i.useState)(!1), O = (0, i.useRef)(!1), L = (0, i.useRef)(null), _ = (0, i.useRef)(null), z = (0, i.useRef)(null), A = (0, i.useRef)(null), I = (0, i.useRef)(null), D = (0, i.useRef)(null), N = (0, i.useRef)(null), G = (0, i.useRef)(null), {
                    params: B,
                    passedParams: j,
                    rest: F,
                    events: H
                ...
                const q = () => {
                    if (Object.assign(B.on, H), E = !0, _.current = new n.ZP(B), _.current.loopCreate = () => {}, _.current.loopDestroy = () => {}, B.loop && (_.current.loopedSlides = u(R, B)), _.current.virtual && _.current.params.virtual.enabled) {
                ...
                return (0, i.useEffect)((() => () => {
                    ...
                    value: _.current
                }, V["container-start"], i.createElement(v, {
                ...
                }(_.current, R, B), V["wrapper-end"]), l(B) && i.createElement(i.Fragment, null, i.createElement("div", {
                    ref: D,
        ...
        8116: function(e, t, s) {
                ...
                for (let s = 1; s < arguments.length; s += 1) {
                    ...
                    if (void 0 !== i && null !== i && !C(i)) {
                        ...
                        for (let t = 0, n = s.length; t < n; t += 1) {
                            ...
                            void 0 !== r && r.enumerable && (y(e[n]) && y(i[n]) ? i[n].__swiper__ ? e[n] = i[n] : S(e[n], i[n]) : !y(e[n]) && y(i[n]) ? (e[n] = {}, i[n].__swiper__ ? e[n] = i[n] : S(e[n], i[n])) : e[n] = i[n])
                        }
                    }
                }
                return e
            ...
            var _ = {
                ...
                updateSlides: function() {
                    ...
                    for (let E = 0; E < p; E += 1) {
                        x = 0;
                        const n = c.eq(E);
                        if (T && e.grid.updateSlide(E, n, p, t), "none" !== n.css("display")) {
                            ...
                            } else x = (r - (i.slidesPerView - 1) * b) / i.slidesPerView, i.roundLengths && (x = Math.floor(x)), c[E] && (c[E].style[t("width")] = `${x}px`);
                            c[E] && (c[E].swiperSlideSize = x), h.push(x), i.centeredSlides ? (y = y + x / 2 + C / 2 + b, 0 === C && 0 !== E && (y = y - r / 2 - b), 0 === E && (y = y - r / 2 - b), Math.abs(y) < .001 && (y = 0), i.roundLengths && (y = Math.floor(y)), S % i.slidesPerGroup === 0 && u.push(y), f.push(y)) : (i.roundLengths && (y = Math.floor(y)), (S - Math.min(e.params.slidesPerGroupSkip, S)) % e.params.slidesPerGroup === 0 && u.push(y), f.push(y), y = y + x + b), e.virtualSize += x + b, C = x, S += 1
                        }
                    }
                    if (e.virtualSize = Math.max(e.virtualSize, r) + g, a && l && ("slide" === i.effect || "coverflow" === i.effect) && n.css({
                        ...
                        }), T && e.grid.updateWrapperSize(x, u, t), !i.centeredSlides) {
                        const t = [];
            ...
            const W = (e, t) => {
                ...
                (i.preventClicks || i.preventClicksPropagation) && r[p]("click", e.onClick, !0), i.cssMode && l[p]("scroll", e.onScroll), i.updateOnWindowResize ? e[u](o.ios || o.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", j, !0) : e[u]("observerUpdate", j, !0)
            };
            var q = {
                attachEvents: function() {
                    ...
                    e.onTouchStart = N.bind(e), e.onTouchMove = G.bind(e), e.onTouchEnd = B.bind(e), s.cssMode && (e.onScroll = H.bind(e)), e.onClick = F.bind(e), i.touch && !R && (t.addEventListener("touchstart", V), R = !0), W(e, "on")
                },
            ...
            class ee {
                constructor() {
                    ...
                    if (1 === i.length && i[0].constructor && "Object" === Object.prototype.toString.call(i[0]).slice(8, -1) ? t = i[0] : [e, t] = i, t || (t = {}), t = S({}, t), e && !t.el && (t.el = e), t.el && g(t.el).length > 1) {
                        const e = [];
                    ...
                    const r = this;
                    r.__swiper__ = !0, r.support = k(), r.device = M({
            ...
            function re(e) {
                ...
                function c() {
                    ...
                    if (t.params.loop ? (c = Math.ceil((t.activeIndex - t.loopedSlides) / t.params.slidesPerGroup), c > i - 1 - 2 * t.loopedSlides && (c -= i - 2 * t.loopedSlides), c > p - 1 && (c -= p), c < 0 && "bullets" !== t.params.paginationType && (c = p + c)) : c = "undefined" !== typeof t.snapIndex ? t.snapIndex : t.activeIndex || 0, "bullets" === s.type && t.pagination.bullets && t.pagination.bullets.length > 0) {
                        ...
                        let n, o, p;
                        if (s.dynamicBullets && (a = i.eq(0)[t.isHorizontal() ? "outerWidth" : "outerHeight"](!0), r.css(t.isHorizontal() ? "width" : "height", a * (s.dynamicMainBullets + 4) + "px"), s.dynamicMainBullets > 1 && void 0 !== t.previousIndex && (l += c - (t.previousIndex - t.loopedSlides || 0), l > s.dynamicMainBullets - 1 ? l = s.dynamicMainBullets - 1 : l < 0 && (l = 0)), n = Math.max(c - l, 0), o = n + (Math.min(i.length, s.dynamicMainBullets) - 1), p = (o + n) / 2), i.removeClass(["", "-next", "-next-next", "-prev", "-prev-prev", "-main"].map((e => `${s.bulletActiveClass}${e}`)).join(" ")), r.length > 1) i.each((e => {
                            const t = g(e),
                                i = t.index();
                    ...
                    if ("fraction" === s.type && (r.find(ne(s.currentClass)).text(s.formatFractionCurrent(c + 1)), r.find(ne(s.totalClass)).text(s.formatFractionTotal(p))), "progressbar" === s.type) {
                        let e;
                        e = s.progressbarOpposite ? t.isHorizontal() ? "vertical" : "horizontal" : t.isHorizontal() ? "horizontal" : "vertical";
                        const i = (c + 1) / p;
                        let n = 1,
                            a = 1;
                        "horizontal" === e ? n = i : a = i, r.find(ne(s.progressbarFillClass)).transform(`translate3d(0,0,0) scaleX(${n}) scaleY(${a})`).transition(t.params.speed)
                    }
                ...
                function f() {
                    ...
                    s.removeClass(e.hiddenClass), s.removeClass(e.modifierClass + e.type), s.removeClass(t.isHorizontal() ? e.horizontalClass : e.verticalClass), t.pagination.bullets && t.pagination.bullets.removeClass && t.pagination.bullets.removeClass(e.bulletActiveClass), e.clickable && s.off("click", ne(e.bulletClass))
                }
                i("init", (() => {
            ...
            function ae(e) {
                ...
                function o() {
                    return "undefined" === typeof t && (!s.autoplay.running && (s.autoplay.running = !0, r("autoplayStart"), l(), !0))
                }
