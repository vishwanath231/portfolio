...
export default function Page() {
          ...
          {DATA.work.map((work, id) => (
            ...
            >
              <ResumeCard
                ...
                href={work.href}
                badges={work.badges}
                period={`${work.start} - ${work.end ?? "Present"} (${work.location})`}
  ...
  Got a question, an idea, or something cool to build together? I&apos;m always open to meaningful conversations, new opportunities, or even just a quick hello.{" "}
  ...
  or message me at{" "}
  <span className="text-blue-500">+91 63852 13119</span>.
</p>
            </div>
          </BlurFade>
        </div>
